...
<%
    ...
    String productName = (String)request.getAttribute("productName"); //洗衣名称查询关键字
...
<body style="background-color:#f5f5f5;background-color:#f5f5f5;">
<jsp:include page="../header.jsp"></jsp:include>
<jsp:include page="../index.jsp"></jsp:include>
<div class="container-fluid" >
	<!--表示总的显示页面将电脑屏幕分成多少份  -->
	<div class="col-md-12 wow fadeInLeft" style="width:100%;padding:0 px;">
		<ul class="breadcrumb" >
  			<li><a href="<%=basePath %>index.jsp">首页</a></li>
  			<li><a href="<%=basePath %>Product/frontlist">洗衣信息列表</a></li>
  			<li class="active">查询结果显示</li>
  			<a class="pull-right" href="<%=basePath %>Product/product_frontAdd.jsp" style="display:none;">添加洗衣</a>
		</ul>
	<!--洗衣 显示列表-->
		<div class="row" >
			<%
				...
				for(int i=0;i<productList.size();i++) {
            		...
            		Product product = productList.get(i); //获取到洗衣对象
            		String clearLeft = "";
            		if(i%6 == 0) clearLeft = "style=\"clear:left;\"";
			%>
			<!--表示每条数据占据多少12份中的多少份-->
			<div class="col-md-2 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>Product/<%=product.getProductId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=product.getMainPhoto()%>" style="width:200px;height:160px;"/></a>
			     <div class="showFields" style="background-color:white ;">
			     <!--
			    	 <div class="field"> 
	            		洗衣类别:<%=product.getProductClassObj().getClassName() %>
			     	</div>  
			     -->	
			     	<div class="field">
			     	...
			     	<!--
			     	<div class="field">
	            		洗衣库存:<%=product.getProductNum() %>
			     	</div>
			     	-->
			     	<div class="field">
	            		洗衣价格:<%=product.getPrice() %>
			     	</div>
			     	<!-- 
			     		<div class="field">
			        ...
			        <a class="btn btn-primary top5" href="<%=basePath %>Product/<%=product.getProductId() %>/frontshow" style="display:none;">详情</a>
	...
	<div class="col-md-12 wow fadeInRight" >
		...
		<form name="productQueryForm" id="productQueryForm" action="<%=basePath %>Product/frontlist" class="mar_t15">
            ...
            <div class="form-group">
            	<label for="productClassObj_classId">洗衣类别：</label>
			...
			<div class="form-group">
				<label for="productName">洗衣名称:</label>
				<input type="text" id="productName" name="productName" value="<%=productName %>" class="form-control" placeholder="请输入洗衣名称">
			</div>
			<div class="form-group">
  ...
  <div class="modal-dialog" style="width:900px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><i class="fa fa-edit"></i>&nbsp;洗衣信息编辑</h4>
      </div>
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="product_productId_edit" class="col-md-3 text-right">洗衣id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="product_productId_edit" name="product.productId" class="form-control" placeholder="请输入洗衣id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="product_productClassObj_classId_edit" class="col-md-3 text-right">洗衣类别:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productName_edit" class="col-md-3 text-right">洗衣名称:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productName_edit" name="product.productName" class="form-control" placeholder="请输入洗衣名称">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_mainPhoto_edit" class="col-md-3 text-right">洗衣图片:</label>
		  	 <div class="col-md-9">
		  ...
		  <div class="form-group">
		  	 <label for="product_productNum_edit" class="col-md-3 text-right">洗衣库存:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_productNum_edit" name="product.productNum" class="form-control" placeholder="请输入洗衣库存">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="product_price_edit" class="col-md-3 text-right">洗衣价格:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="product_price_edit" name="product.price" class="form-control" placeholder="请输入洗衣价格">
			 </div>
		  </div>
		  <div class="form-group">
		  ...
		  <div class="form-group">
		  	 <label for="product_productDesc_edit" class="col-md-3 text-right">洗衣描述:</label>
		  	 <div class="col-md-9">
...
<script>
//实例化编辑器
var product_productDesc_edit = UE.getEditor('product_productDesc_edit'); //洗衣描述编辑器
