...
<div id="product_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="productQueryForm" method="post">
			...
			洗衣类别：<input class="textbox" type="text" id="productClassObj_classId_query" name="productClassObj.classId" style="width: auto"/>
			洗衣名称：<input type="text" class="textbox" id="productName" name="productName" style="width:110px" />
...
var product_productDesc_editor = UE.getEditor('product_productDesc_edit'); //洗衣描述编辑器
</script>
