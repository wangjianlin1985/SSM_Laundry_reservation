...
<body style="margin-top:90px;background-color:#f5f5f5; ">
<div class="container">
		...
		<div class="row" >
			...
			<div class="col-md-5">
				  ...
				  <div class="form-group" >
					 <label for="userInfo_user_name" class="col-md-3 text-right">用户名:</label>
					 <div class="col-md-8"> 
					 	<input type="text" id="userInfo_user_name" name="userInfo.user_name" class="form-control" placeholder="请输入用户名">
					 </div>
				  </div> 
				  <div class="form-group" >
				  	 <label for="userInfo_password" class="col-md-3 text-right">登录密码:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_gender" class="col-md-3 text-right">性别:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_gender" name="userInfo.gender" class="form-control" placeholder="请输入性别">
					 </div>
				  </div>
				  <div class="form-group">
				  	 <label for="userInfo_birthDateDiv" class="col-md-3 text-right">出生日期:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_userPhoto" class="col-md-3 text-right">用户照片:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group">
				  	 <label for="userInfo_email" class="col-md-3 text-right">邮箱:</label>
				  	 <div class="col-md-8">
				  ...
				  <div class="form-group"  style="display:none;">
				  	 <label for="userInfo_userMoney" class="col-md-3 text-right">账户余额:</label>
				  	 <div class="col-md-8">
					    <input type="text" id="userInfo_userMoney" name="userInfo.userMoney" class="form-control" placeholder="请输入账户余额">
					 </div>
				  </div>
				  <div class="form-group" style="display:none;">
				  	 <label for="userInfo_regTimeDiv" class="col-md-3 text-right">注册时间:</label>
				  	 <div class="col-md-8">
